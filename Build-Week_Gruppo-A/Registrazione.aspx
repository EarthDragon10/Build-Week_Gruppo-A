    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div style="max-width: 300px">
                ...
                <asp:RequiredFieldValidator ID="Nome_Validator" runat="server" ErrorMessage="Campo richiesto" ValidationGroup="Dati_Registrazione" ControlToValidate="TEXTBOX_Nome"></asp:RequiredFieldValidator>
                <asp:TextBox ID="TEXTBOX_Cognome" CssClass="form-control mt-2" placeholder="Cognome" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="Cognome_Validator" runat="server" ErrorMessage="Campo richiesto" ValidationGroup="Dati_Registrazione" ControlToValidate="TEXTBOX_Cognome"></asp:RequiredFieldValidator>
                <asp:TextBox ID="TEXTBOX_Email" CssClass="form-control mt-2" placeholder="Email" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="Email_Validator" runat="server" ErrorMessage="Campo richiesto" ValidationGroup="Dati_Registrazione" ControlToValidate="TEXTBOX_Email"></asp:RequiredFieldValidator>
                <asp:TextBox ID="TEXTBOX_Username" CssClass="form-control mt-2" placeholder="Username" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="Username_Validator" runat="server" ErrorMessage="Campo richiesto" ValidationGroup="Dati_Registrazione" ControlToValidate="TEXTBOX_Username"></asp:RequiredFieldValidator>
                <asp:TextBox ID="TEXTBOX_Password" CssClass="form-control mt-2" placeholder="Password" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="Password_Validator" runat="server" ErrorMessage="Campo richiesto" ValidationGroup="Dati_Registrazione" ControlToValidate="TEXTBOX_Password"></asp:RequiredFieldValidator>
                ...
                <asp:RequiredFieldValidator ID="Indirizzo_Validator" runat="server" ErrorMessage="Campo richiesto" ValidationGroup="Dati_Registrazione" ControlToValidate="TEXTBOX_Indirizzo"></asp:RequiredFieldValidator>
                ...
                <asp:RequiredFieldValidator ID="Data_Validator" runat="server" ErrorMessage="Campo richiesto" ValidationGroup="Dati_Registrazione" ControlToValidate="TEXTBOX_DatadiNascita"></asp:RequiredFieldValidator>
